...
async def create_repository(
    ...
    Args:
        ...
        owner: Optional owner for the repository.
...
async def create_or_update_file(
    ...
    """
    Creates or updates a file in the specified repository and branch.
    
    Attempts to create a new file or update an existing file at the given path using the provided content and metadata. Returns a dictionary indicating success and file information, or an error message if the operation fails.
    """
    try:
...
async def get_file_contents(
    ...
    Args:
        ...
        branch: The branch name to retrieve contents from. If not provided, defaults to the repository's default branch.
    
    Returns:
        A dictionary with a success flag and either the contents of the file or directory, or an error message if retrieval fails.
    """
    try:
...
async def create_pull_request(
    ...
    Args:
        owner: The username or organization that owns the repository.
        repo: The name of the repository.
        pr_data: Data specifying the pull request details, including title, body, head and base branches, draft status, and maintainer modification permission.
    
    Returns:
        A dictionary indicating success and containing pull request information if successful, or an error message if the operation fails.
    """
    try:
...
async def search_repositories(
    ...
    Returns:
        A dictionary with a success flag and either a list of repositories or an error message.
    """
    try:
...
async def search_code(
    ...
    """
    Searches for code across GitHub repositories using the specified query.
    ...
    Returns:
        A dictionary with a success flag and either the search results or an error message.
    """
    try:
...
async def list_issues(
    ...
    Args:
        ...
        labels: Optional list of label names to filter issues.
...
async def list_pull_requests(
    ...
    """
    Retrieves a list of pull requests for a repository with optional filtering.
    
    Args:
        state: Filter pull requests by state (open, closed, or all).
        head: Filter by the head branch name.
        base: Filter by the base branch name.
        page: Page number for pagination.
        per_page: Number of results per page.
    
    Returns:
        A dictionary indicating success and containing the list of pull requests or an error message.
    """
    try:
...
async def create_branch(
    ...
    Returns:
        A dictionary indicating success or failure, with branch information or error details.
    """
    try:
...
async def fork_repository(
    ...
    Returns:
        A dictionary indicating success or failure, with fork details or error information.
    """
    try:
...
async def merge_pull_request(
    ...
    Attempts to merge the given pull request using the specified merge method, commit title, and commit message. Returns a dictionary indicating success or failure, along with merge details or an error message.
    """
    try:
