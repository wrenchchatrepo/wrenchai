...
class Agent:
    ...
    def __post_init__(self):
        ...
        Ensures that the agent possesses all required capabilities based on its type.
        """
        self.validate_capabilities()
    
    def validate_capabilities(self):
        """
        Validates that the agent possesses all required capabilities for its type.
        
        Raises:
            ValueError: If the agent lacks mandatory capabilities based on its type.
        """
